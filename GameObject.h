...
public:
	...
	void movePlayer(char, Grid*, Character*);		//char argument is for captured keystrokes indicating which direction player is being directed to move		
														//grid argument for manipulating grid array, character argument for interacting with other characters (eg doing battle)
};
...
public:
	Goblin(Grid*);
	void moveGoblin(Grid*, Character*);				//random movmement of Goblin
};
